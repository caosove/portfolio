...
<html>
	<head>
		...
		<link rel="stylesheet" href="/this14/Cart/css/reset.css" type="text/css">
		<link rel="stylesheet" href="/this14/Cart/css/main.css" type="text/css">
		<link rel="stylesheet" href="/this14/Cart/css/Style1.css" type="text/css">
    ...
    border-left: 1px solid rgba(255,255,255,.15);padding-top:0" class="nav-right-banner showroom" href="<%=request.getContextPath()%>/this14/admin/indexAdmin.jsp">관리자</a>
	         ...
	         <div class="login-content"> 
	             ...
	             <form action="<%=request.getContextPath() %>/this14/login/login_action.jsp" method="POST" class="login-form" name="login_form"> 
	               ...
	               <div class="login-footer"><a href="<%=request.getContextPath() %>/login/lookup_info.jsp" class="login-join">아이디/비밀번호 찾기</a>&nbsp;│&nbsp;<a href="<%=request.getContextPath() %>/this14/login/join_step_01.jsp" class="login-join">회원가입</a></div> 
	             </form> 
	         </div> 
	    </div>
