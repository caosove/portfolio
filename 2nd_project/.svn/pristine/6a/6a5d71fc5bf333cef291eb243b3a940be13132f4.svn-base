			...
			<div class="col-md-12">
				<div class="cart-view-area">
					<div class="cart-view-table">
						<form method="post" action="checkout.jsp?&sts=5">
 ...
 */
									...
									List<StockListDTO> stockList = StockListDAO.getDAO().getcartList(name, grade, startRow, endRow, search,
											keyword);
								...
								<table class="table">
									...
									<tbody>
										...
										<tr>
											<td><a class="remove" onclick="delchk(<%=num%>)"> <input
													type="hidden" name="pknum" value="<%=article.getNum()%>"
													readonly> <input type="hidden" name="kknum">
													<fa class="fa fa-close"></fa></a></td>
											<td><a href="<%=request.getContextPath()%>/this14/product/index.jsp?workgroup=product&work=product_detail&pID=<%=product.getpID()%>">
											 <img src="<%=request.getContextPath()%>/this14/product/images/product_image/<%=article.getPname()%>.jpg" ></a></td>

											<td>
											
											<a class="aa-cart-title" href="<%=request.getContextPath()%>/this14/product/index.jsp?workgroup=product&work=product_detail&pID=<%=product.getpID()%>">
											...
											<td><input type="text"
												...
												name="sum" size="11" readonly> <%-- <%= df.format(val)%>  --%>(원)</td>
										</tr>
