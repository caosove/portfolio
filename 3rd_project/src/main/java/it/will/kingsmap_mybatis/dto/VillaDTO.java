...
NAME varchar2(100), -- 빌라 이름
TYPE varchar2(100), -- 빌라 형태(전/ 월세 / 매매 )---
contract varchar2(100), -- 빌라 전용면적
silcontract varchar2(100), -- 빌라 실면적
ymdate varchar2(100), -- 빌라 거래년월
ddate varchar2(100), -- 빌라 거래일자
Trading varchar2(100), -- 빌라 매매가
deposit varchar2(100), -- 빌라 보증금
monthly varchar2(100), -- 빌라 월세 (추가)
floor varchar2(100), -- 빌라 층수
ybuild varchar2(100), --  빌라 건축년도
newaddr varchar2(100) --  빌라 도로명주소
);
*/
...
public class VillaDTO {
	...
	public String getSILCONTRACT() {
		return SILCONTRACT;
	}

	public void setSILCONTRACT(String sILCONTRACT) {
		SILCONTRACT = sILCONTRACT;
	}
