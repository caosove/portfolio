		...
		<table class="table table-bordered table-hover"
			...
			<thead>
				<tr align="center">
					...
					<th width="20%">매매(천만원)<BR></th>
					<th width="20%">전세(천만원)<BR></th>
					<th width="20%">월세(만원)<BR></th>
					<th width="15%">면적(㎡)<BR></th>
					<!-- <th width="20%">공시가(㎡/만원)<BR></th> -->
					<th width="10%">타입</th>
				</tr>
			</thead>
						...
						<tbody>
							<tr align="center">
								...
								<%-- <td width="20%"><c:forEach var="price" items="${gongsi}">
										<fmt:formatNumber value="${price.OFFICIALPRICE}"
											pattern="#,###" />
									</c:forEach></td> --%>
		...
		<table class="table table-bordered table-hover" style= "text-align: center;  border: 1px solid #dddddd;">
			<thead style = "background-color: #006dcc;">
				<tr align="center" style= "color:white">
					<td width="35%" >기준년도</td>
					<td width="65%">공시지가(㎡/만원)</td>
				</tr>
			</thead>
			<tbody>
			<c:forEach var="price" items="${gongsi}">
				<tr align="center">
				<td width="35%">${price.OFFICIALDATE}</td>
				<td width="65%"><fmt:formatNumber value="${price.OFFICIALPRICE}"/></td>
			</tr>
			</c:forEach>
			</tbody>
		...
		var mixChart = new Chart(mix, {
			...
			data : {
				...
				datasets : [ {
					...
					backgroundColor : 'rgba(0, 109, 204, 0.5)',
					yAxisID : 'maemae',
				} ]
			},
			options : {
